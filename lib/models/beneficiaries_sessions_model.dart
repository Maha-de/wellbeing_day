...
//
//     final beneficiarySessionsModel = beneficiarySessionsModelFromJson(jsonString);

import 'dart:convert';

BeneficiarySessionsModel beneficiarySessionsModelFromJson(String str) => BeneficiarySessionsModel.fromJson(json.decode(str));

String beneficiarySessionsModelToJson(BeneficiarySessionsModel data) => json.encode(data.toJson());

class BeneficiarySessionsModel {
  List<EdSession>? scheduledSessions;
  List<EdSession>? completedSessions;

  BeneficiarySessionsModel({
    this.scheduledSessions,
    this.completedSessions,
  });

  factory BeneficiarySessionsModel.fromJson(Map<String, dynamic> json) => BeneficiarySessionsModel(
