...
class ImprovingTrust extends StatefulWidget {
  final String category;
  final String subCategory;
  const ImprovingTrust(
      {super.key, required this.category, required this.subCategory});

  @override
  State<ImprovingTrust> createState() => _ImprovingTrustState();
}

class _ImprovingTrustState extends State<ImprovingTrust> {
