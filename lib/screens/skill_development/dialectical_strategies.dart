...
class DialecticalStrategies extends StatefulWidget {
  final String category;
  final String subCategory;
  const DialecticalStrategies(
      {super.key, required this.category, required this.subCategory});

  @override
  State<DialecticalStrategies> createState() => _DialecticalStrategiesState();
}

class _DialecticalStrategiesState extends State<DialecticalStrategies> {
