...
class StressManagement extends StatefulWidget {
  ...
  @override
  State<StressManagement> createState() => _StressManagementState();
}

class _StressManagementState extends State<StressManagement> {
