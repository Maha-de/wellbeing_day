...
class EmotionalControl extends StatefulWidget {
  ...
  @override
  State<EmotionalControl> createState() => _EmotionalControlState();
}

class _EmotionalControlState extends State<EmotionalControl> {
