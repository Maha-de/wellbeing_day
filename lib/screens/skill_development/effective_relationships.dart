...
class EffectiveRelationships extends StatefulWidget {
  ...
  @override
  State<EffectiveRelationships> createState() => _EffectiveRelationshipsState();
}

class _EffectiveRelationshipsState extends State<EffectiveRelationships> {
