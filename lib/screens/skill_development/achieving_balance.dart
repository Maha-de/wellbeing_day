...
class AchievingBalance extends StatefulWidget {
  final String category;
  final String subCategory;
  const AchievingBalance(
      {super.key, required this.category, required this.subCategory});

  @override
  State<AchievingBalance> createState() => _AchievingBalanceState();
}

class _AchievingBalanceState extends State<AchievingBalance> {
