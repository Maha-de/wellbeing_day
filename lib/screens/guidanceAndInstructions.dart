...
class Guidance_instructions extends StatefulWidget {
  ...
  @override
  State<Guidance_instructions> createState() => _Guidance_instructionsState();
}

class _Guidance_instructionsState extends State<Guidance_instructions> {
