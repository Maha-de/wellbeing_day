              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                    label: "firstName".tr(),
                    controller:
                        context.read<GetSpecialistCubit>().firstNameController,
                    validator: (value) => isSubmitted
                        ? validateName(value, "firstName".tr())
                        : null,
                  ),
                  CustomTextField(
                    label: "lastName".tr(),
                    controller:
                        context.read<GetSpecialistCubit>().lastNameController,
                    validator: (value) => isSubmitted
                        ? validateName(
                            value,
                            "lastName".tr(),
                  ...
                  CustomTextField(
                    label: "email".tr(),
                    controller:
                        context.read<GetSpecialistCubit>().emailController,
                    validator: (value) => isSubmitted
                        ? validateEmail(
                            value,
                            "email".tr(),
                  ...
                  CustomTextField(
                    label: "password".tr(),
                    controller:
                        context.read<GetSpecialistCubit>().passwordController,
                    validator: (value) => isSubmitted
                  ...
                  CustomTextField(
                    ...
                    controller:
                        context.read<GetSpecialistCubit>().phoneController,
                    validator: (value) => isSubmitted
                        ? validatePhone(value, "phoneNumber".tr())
                        : null,
                  ...
                  CustomTextField(
                    ...
                    validator: (value) => isSubmitted
                        ? validateNationality(value, "nationality".tr())
                        : null,
                  ...
                  CustomTextField(
                    label: "profession".tr(),
                    controller:
                        context.read<GetSpecialistCubit>().workController,
                    validator: isSubmitted
                  ...
                  CustomTextField(
                    ...
                    validator: isSubmitted
                        ? (value) =>
                            validateAddress(value, "professionAddress".tr())
                        : null,
                    suffixIcon: Icons.location_city,
                  ),
                  CustomTextField(
                  ...
                  CustomTextField(
                    ...
                    label: "experience".tr(),
                    controller:
                        context.read<GetSpecialistCubit>().exp_year_Controller,
                    validator: (value) => isSubmitted
                        ? validateYearsOfExperience(value, "experience".tr())
                        : null,
                    suffixIcon: Icons.work_history,
                  ),
                  CustomTextField(
                    ...
                    controller: context
                        .read<GetSpecialistCubit>()
                        .session_time_Controller,
                    validator: isSubmitted
                        ? (value) => validateSessionDetails(
                            value, "sessionDuration".tr())
                        : null,
                  ...
                  CustomTextField(
                    ...
                    controller: context
                        .read<GetSpecialistCubit>()
                        .session_price_Controller,
                    validator: isSubmitted
                        ? (value) =>
                            validateSessionDetails(value, "sessionPrice".tr())
                        : null,
                  ...
                  CustomUploadFile(
                    ...
                    validator: (value) => validateUpload(value, "cv".tr()),
                  ...
                  CustomUploadFile(
                    ...
                    validator: (value) =>
                        validateUpload(value, "certificates".tr()),
                    onFilePicked: (PlatformFile? file) {
                      if (file != null) {
                        certificates = file;
                      } else {
                  ...
                  CustomUploadFile(
                    label: "license".tr(),
                    validator: (value) => validateUpload(value, "license".tr()),
                      ...
                      if (signUpFormKey.currentState?.validate() ?? false) {
                        Specialist doctor = Specialist.withoutSpeciality(
                          ...
                          bio: context
                              ...
                              .about_doctor_Controller
                              .text,
                          yearOfExperience: int.tryParse(context
                              .read<GetSpecialistCubit>()
                              .exp_year_Controller
                              .text)!,
