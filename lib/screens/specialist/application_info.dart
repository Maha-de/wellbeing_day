...
class ApplicationInfoDoctor extends StatefulWidget {
  ...
  @override
  State<ApplicationInfoDoctor> createState() => _ApplicationInfoDoctorState();
}

class _ApplicationInfoDoctorState extends State<ApplicationInfoDoctor> {
  @override
...
class _SocialMediaPageState extends State<SocialMediaPage> {
  ...
  Widget AppearedItemFromTabls(int index) {
    switch (index) {
      case 3:
        return const DoctorInstructions1();
